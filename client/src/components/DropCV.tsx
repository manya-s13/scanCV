  ...
  return (
    <div id="Drop" className='mt-40 mb-10'>
        <div className='flex flex-col items-center justify-center'>
            ...
            <div className="flex flex-col items-center justify-center mt-20 border border-dashed rounded-xl border-gray-500 w-80 h-80 md:w-150 md:h-100 hover:bg-blue-100">
