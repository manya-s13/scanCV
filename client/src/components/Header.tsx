    ...
    <div className='sticky top-0 backdrop-blur-xl  text-black pt-9 overflow-hidden pb-3'>
        <div className='flex flex-row justify-around items-center'>
            ...
            <div className='text-xl flex flex-row justify-end gap-10 items-center'>
                <a href="/" className='hidden md:flex hover:text-blue-500 cursor-pointer'>Home</a>
                <a onClick={()=> scrollToSection('Features')} className='hidden md:flex hover:text-blue-500 cursor-pointer'>Why Us?</a>
